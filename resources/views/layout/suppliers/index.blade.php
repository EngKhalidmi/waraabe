...
<div class="page-btn">
<a href="{{route('supplier.add')}}" class="btn btn-added"><img src="{{asset('/assets/img/icons/plus.svg')}}" alt="img">Add Supplier</a>
</div>
</div>
...
<input type="text" id="name" placeholder="Filter By Supplier Name">
</div>
</div>
...
<select name="type" id="type" class="select">
    <option value="" selected>Filter Balance</option>
        ...
        columns: [
            ...
            { data: 'created_at', name: 'created_at' },
            {
                ...
                render: function (data, type, row) {
                    let deleteUrl = `{{ url('suppliers/suppliers') }}/${data}`;
                    let editUrl = `{{ url('suppliers/suppliers/${data}/edit') }}`;
                    return `
