...
<h4>Capital List</h4>
<h6>Manage your Capitals</h6>
</div>
<div class="page-btn">
<a href="{{route('capital.add')}}" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img">Add Capital</a>
</div>
</div>
...
<input type="text" id="name" placeholder="Filter By Owner Name">
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<input type="text" id="amount" placeholder="Filter By Amount">
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
...
<table class="table" id="CapitaTable">
<thead>
<tr>
<th>#</th>
<th>Owner Name</th>
...
<tbody>
    ...
    $(document).ready(function() {
        if (!navigator.onLine && window.StoreManagementFinanceModule) {
            window.StoreManagementFinanceModule.mountListPage('capital');
            return;
        }

    // Initialize the DataTable
    let table = $('#CapitaTable').DataTable({
        processing: true,
        serverSide: true,
        lengthMenu: [10, 25, 50],
        ajax: {
            ...
            dataSrc: function (json) {
                if (window.StoreManagementFinanceModule) {
                    window.StoreManagementFinanceModule.cacheList('capital', json.data || []);
                }
        ...
        columns: [
            ...
            { data: 'created_at', name: 'created_at' },
            {
                ...
                render: function (data, type, row) {
                    let deleteUrl = `{{ url('capital/capital') }}/${data}`;
                    return `
