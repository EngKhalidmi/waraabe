...
<h4>Bank Statement List</h4>
<h6>Manage your Bank Statements</h6>
</div>
<div class="page-btn">
<a href="{{route('bankStatement.add')}}" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img">Add Bank Statement</a>
</div>
</div>
...
<input type="text" id="description" placeholder="Filter By Description">
</div>
</div>
...
<table class="table" id="bankStatement">
<thead>
<tr>
<th>#</th>
        ...
        columns: [
            ...
            { data: 'description', name: 'description' },
            {
                ...
                render: function (data, type, row) {
                    let deleteUrl = `{{ url('bankStatement/bankStatement') }}/${data}`;
                    return `
