...
@section('title', 'Saacid - Finance Activity Report')
@section('admin')
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Finance Activity Report</h4>
                    <h6>Manage Your Finance Activity</h6>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <p>{{ $settings->company_address ?? 'Kaalinta Shiidaalka Waraabe, Berbera Somaliland' }}
                    ...
                    ZAAD: {{ $settings->zaad ?? '' }} | EDAHAB: {{ $settings->edahab ?? '' }}
                            ...
                            <hr>
                            <h4 class="card-title">Financial Transactions Report</h4>
                        </center>
    ...
    <script>
        function getFinanceReport() {
            ...
            let url = `{{ route('info.financeActivity') }}`;
        ...
        function appendToTable(data, tableBody) {
            var tableRow = '<tr>' +
                '<td>' + data.date + '</td>' +
                '<td>' + data.depitAcc + '</td>' +
                '<td>' + data.depitAmount + '</td>' +
                '<td>' + data.creditAcc + '</td>' +
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            // Save the XLSX file
            XLSX.writeFile(wb, "FinanceActivity.xlsx");
        }
