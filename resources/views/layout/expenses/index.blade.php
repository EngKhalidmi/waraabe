    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('expense.add') }}" class="btn btn-added"><img src="assets/img/icons/plus.svg"
                            alt="img">Add Expense</a>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-13">
                                    <div class="form-group">
                                        <input type="text" id="type" placeholder="Filter By Name">
                                    </div>
                                </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let deleteUrl = `{{ url('expenses/expenses') }}/${data}`;
                            return `
